  ...
  return (
    <main className="h-full w-full mt-5">
      <div className="flex flex-col items-center justify-center h-full w-full">
        <h1 className="text-4xl md:text-6xl font-bold">Kepoin Paket</h1>
        <p className="text-lg md:text-xl my-2">Mau tau paket kamu lagi dimana cari yuk!</p>
        <ExpeditionList onSelect={handleExpeditionSelect} />
        <div className="flex flex-col items-center justify-center w-full mt-2 md:flex-row md:w-1/2 mx-2">
          <input
            type="text"
        ...
        {!awbInput && (
          <h3 className="text-blue-500 text-base md:text-lg">*wajib memasukkan nomor resi, yaaa</h3>
        )}
        {searchResult && (
          <div className="mt-4">
        ...
        {isLoading && (
          <div className="mt-4 flex items-center justify-center">
            <div role="status">
              <svg aria-hidden="true" className="inline w-16 h-16 md:w-20 md:h-20 mr-2 text-blue-200 animate-spin blue:text-blue-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
